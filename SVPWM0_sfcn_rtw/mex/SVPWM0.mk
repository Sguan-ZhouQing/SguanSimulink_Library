...
MODEL                   = SVPWM0
MODULES                 = SVPWM0_sf.c SVPWM0_sf_data.c rtGetNaN.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\SVPWM0_sf.mexw64
MAKEFILE                = SVPWM0.mk
MATLAB_ROOT             = E:\Program Files\MATLAB\R2025a
ALT_MATLAB_ROOT         = E:\PROGRA~1\MATLAB\R2025a
...
ADDITIONAL_LDFLAGS      =  /IMPLIB:SVPWM0_sf.lib /EXPORT:mexFunction /EXPORT:mexfilerequiredapiversion
...
SYSTEM_LIBS             = /LIBPATH:"E:\Program Files\MATLAB\R2025a\extern\lib\win64\microsoft" libut.lib libfixedpoint.lib libmx.lib libmex.lib
...
MODELLIB                  = SVPWM0_sf.mexw64
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = SVPWM0_ref.rsp
...
SVPWM0_sf.obj : $(START_DIR)\SVPWM0_sfcn_rtw\SVPWM0_sf.c
	@cmd /C echo ### Compiling "$(START_DIR)\SVPWM0_sfcn_rtw\SVPWM0_sf.c"
	$(CC) $(CFLAGS) $(START_DIR)\SVPWM0_sfcn_rtw\SVPWM0_sf.c

SVPWM0_sf_data.obj : $(START_DIR)\SVPWM0_sfcn_rtw\SVPWM0_sf_data.c
	@cmd /C echo ### Compiling "$(START_DIR)\SVPWM0_sfcn_rtw\SVPWM0_sf_data.c"
	$(CC) $(CFLAGS) $(START_DIR)\SVPWM0_sfcn_rtw\SVPWM0_sf_data.c

rtGetNaN.obj : $(START_DIR)\SVPWM0_sfcn_rtw\rtGetNaN.c
	@cmd /C echo ### Compiling "$(START_DIR)\SVPWM0_sfcn_rtw\rtGetNaN.c"
	$(CC) $(CFLAGS) $(START_DIR)\SVPWM0_sfcn_rtw\rtGetNaN.c
