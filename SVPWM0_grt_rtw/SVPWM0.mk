###########################################################################
## Makefile generated for component 'SVPWM0'. 
## 
## Makefile     : SVPWM0.mk
## Generated on : Mon Jan 05 17:33:16 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\SVPWM0.exe
...
PRODUCT_NAME              = SVPWM0
MAKEFILE                  = SVPWM0.mk
MATLAB_ROOT               = E:\PROGRA~1\MATLAB\R2025a
MATLAB_BIN                = E:\PROGRA~1\MATLAB\R2025a\bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)\win64
START_DIR                 = D:\星必尘Sguan\Desktop\SVPWM及逆变器模型
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = ISO_C
...
COMPILER_COMMAND_FILE     = SVPWM0_comp.rsp
CMD_FILE                  = SVPWM0.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\SVPWM0.exe
...
DEFINES_STANDARD = -DMODEL=SVPWM0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\SVPWM0_grt_rtw\SVPWM0.c $(START_DIR)\SVPWM0_grt_rtw\SVPWM0_data.c $(START_DIR)\SVPWM0_grt_rtw\rtGetNaN.c $(START_DIR)\SVPWM0_grt_rtw\rt_nonfinite.c
...
OBJS = rt_logging.obj SVPWM0.obj SVPWM0_data.obj rtGetNaN.obj rt_nonfinite.obj
...
{$(START_DIR)\SVPWM0_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SVPWM0_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SVPWM0_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\SVPWM0_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
SVPWM0.obj : "$(START_DIR)\SVPWM0_grt_rtw\SVPWM0.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SVPWM0_grt_rtw\SVPWM0.c"


SVPWM0_data.obj : "$(START_DIR)\SVPWM0_grt_rtw\SVPWM0_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SVPWM0_grt_rtw\SVPWM0_data.c"


rtGetNaN.obj : "$(START_DIR)\SVPWM0_grt_rtw\rtGetNaN.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SVPWM0_grt_rtw\rtGetNaN.c"


rt_nonfinite.obj : "$(START_DIR)\SVPWM0_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\SVPWM0_grt_rtw\rt_nonfinite.c"
